...
Page({
  ...
  submit: function() {
    var t = this,
      i = t.data.detail;
    if (!t.data.posting) {
      if ("" == i.realname || !i.realname) return void a.toast(t, "请填写收件人");
      if ("" == i.mobile || !i.mobile) return void a.toast(t, "请填写联系电话");
      if ("" == i.city || !i.city) return void a.toast(t, "请选择所在地区");
      if (t.data.street.length > 0 && ("" == i.street || !i.street)) return void a.toast(t, "请选择所在街道");
      if ("" == i.address || !i.address) return void a.toast(t, "请填写详细地址");
      if (!i.datavalue) return void a.toast(t, "地址数据出错，请重新选择");
      i.id = t.data.id, t.setData({
        posting: !0
