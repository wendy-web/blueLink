...
module.exports = {
  ...
  json: function (t, n, o, i, a, c) {
    ...
    var d = this;
    if(r.globalData.mealsList.mid){
      r.globalData.mealsList.mid != '' ? n.mid = r.globalData.mealsList.mid : '';
    }
    // console.log("uid"+r.globalData.mealsList.mid);
    i && d.loading(),
      n && (n.authkey = f || "");
  ...
  onShareAppMessage: function(t) {
    ...
    return o.title && (c = o.title), o.desc && (r = o.desc), i && (a = i.id), t = t || "pages/member/index/index", t = -1 != t.indexOf("?") ? t + "&" : t + "?", {
      title: c,
      desc: r,
      path: t + "mid=" + a
    }
