...
var t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(n) {
  ...
  s = {
    ...
    each: function(n, t, e) {
      ...
      if (e) {
        if (u)
          for (; i < o && !1 !== t.apply(n[i], e); i++);
        else
          for (i in n)
            if (!1 === t.apply(n[i], e)) break
      } else if (u)
        for (; i < o && !1 !== t.call(n[i], i, n[i]); i++);
      else
        for (i in n)
...
s.extend = function() {
  ...
  for ("boolean" == typeof f && (l = f, f = arguments[1] || {}, a = 2), "object" === (void 0 === f ? "undefined" : t(f)) || s.isFunction(f) || (f = {}), c === a && (f = this, --a); a < c; a++)
    if (null != (n = arguments[a]))
      for (r in n) e = f[r], i = n[r], f !== i && (l && i && (s.isPlainObject(i) || (o = s.isArray(i))) ? (o ? (o = !1, u = e && s.isArray(e) ? e : []) : u = e && s.isPlainObject(e) ? e : {}, f[r] = s.extend(l, u, i)) : void 0 !== i && (f[r] = i));
  return f
  ...
  if (void 0 === t && (t = !1), s.isArray(r) || r.jquery && !s.isPlainObject(r)) s.each(r, function() {
    o(this.name, this.value)
  });
  else
    for (e in r) n(e, r[e], t, o);
